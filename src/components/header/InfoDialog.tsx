      ...
      <div className="info-dialog-body">
        ...
        <ul className="feature">
          ...
          <svg className="feature-icon" viewBox="0 0 24 24" width="16" height="16">
            ...
            <strong>Grid Editor:</strong> Create and edit ASCII art on a customizable grid.</li>
            <li>
          <svg className="feature-icon" viewBox="0 0 24 24" width="16" height="16">
          ...
          <strong>Symbol Selector:</strong> Select from a variety of symbols, including support for alt characters.</li>
          <li>
          <svg className="feature-icon" viewBox="0 0 24 24" width="16" height="16">
